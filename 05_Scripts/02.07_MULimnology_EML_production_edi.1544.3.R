...
###Updated version of edi.1544.2 to edi.1544.3
##Created 29Oct2024 by David Richardson (hereafter DCR)
##Includes 1989-2022 profiles
...
#Create files and attribute tables####
  ...
  write_csv(x=metaDataFromDatabase_edi,file=paste0(edi.folder,"MissouriReservoirs_Metadata_SiteData.csv"))
...
make_eml(path = edi.folder,
         dataset.title = "Missouri reservoir profile data including temperature, depth, and oxygen profiles (1989-2022)", 
